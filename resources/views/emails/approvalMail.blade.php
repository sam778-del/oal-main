...
<p>Kindly log in to the investment portal at <a href="{{ $data->link }}" target="_blank">{{ $data->link }} ?></a>. The banking instruction details are available for download on the My Investment Details page. Once you have transferred your funds from your bank, please upload the wire transfer slip/details as proof of funding in the portal.</p>
