                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 ">
                                    <div class="card card-margin">
                                        ...
                                        <div class="card-body">
                                             {!! Form::open(['url' => '/subscriptionSave', 'files' => true, 'id' => 'subscriptionform', 'data-parsley-validate' => 'data-parsley-validate', "data-parsley-trigger"=>"keyup", 'autocomlete'=>"off" ]) !!}
                                                ...
                                                <div>
                                                    ...
                                                    <section>
                                                        ...
                                                        <div class="row">
                                                                @include("investor.elements.editSubscription")
                                                        </div>
                                                    </section>
                                                    ...
                                                    <section>
                                                        ...
                                                        @include("investor.elements.editAdditional")
                                                    </section>

                                                    <h3>DOCUMENTS</h3>
                                                    <section>
                                                        <h4>CHECKLIST FOR SUBSCRIBERS</h4>
                                                        @include("investor.elements.editDocument")
                                                    </section>
