                    ...
                    <div class="col-lg-12 card-margin">
                        <div class="card">
                            <div class="card-body">
                                ...
                                {!! Form::open(['url' => 'changeStatus', 'files' => true, 'id' => 'changeStatusForm', 'data-parsley-validate' => 'data-parsley-validate', 'autocomlete'=>"off" ]) !!}
                                @csrf
                                    <div class="row">
                                    ...
                                    <div class="table-responsive table-space-sm">
                                        <table class="table table-borderless">
                                    	    <tbody>
                                    	        ...
                                    	        <tr>
                                    	            <th>Email</th>
                                    	            <td>{{ $subscription['UserAs']['email'] }}</td>
                                    	        ...
                                    	        <tr>
                                    	            <th>Mobile No</th>
                                    	            <td>+{{ $subscription['UserAs']['mobile_prefix'] }} - {{ $subscription['UserAs']['mobile_no'] }}</td>
                                ...
                                <div class="row col-md-12 show-first-sec">
                                    <div class="table-responsive">
                                        <table class="table table-borderless">
                                    	    <tbody>
                                    	        <tr>
                                    	            <td>{{ $subscription->address_line1 }} {{ $subscription->address_line2 }} {{ $subscription->city }} {{ $subscription->post_code }} {{ $subscription['SubscriptionStateAs']['name'] }} {{ $subscription['SubscriptionCountryAs']['name'] }}</td>
                                    	        </tr>
                                    	    </tbody>
                                    	 </table>
                                    </div>
                                ...
                                <?php if($subscription->changebank_request == 1){ ?>
                                    ...
                                    <div class="col-md-1">
                                        <a type="button" href="{{ asset('storage/'.$subscription->changebank_file) }}" class="btn btn-primary btn-sm" download style="float: right"> Download</a>
                                    </div>
    							        ...
    							        <table class="table table-borderless">
    									    <tbody>
    									        <tr>
    									            ...
    									            <td>{{ $subscription->bank_address }}</td>
    									        </tr>
    									        <tr>
    									            <th>Account Name</th>
    									            <td>{{ $subscription->account_name }}</td>
    									            <th>Account Number</th>
    									            <td>{{ $subscription->account_number }}</td>
    									        </tr>
    									        <tr>
                                    	            <th>Swift Address</th>
                                    	            <td>{{ $subscription->swift_address }}</td>
                                    	            <th>Bank IBAN#</th>
                                    	            <td>{{ $subscription->bank_inan }}</td>
                                    	        </tr>
                                    	        <tr>
                                    	            <th>Reference</th>
                                    	    ...
                                    	    <tbody>
                                    	        <tr>
                                    	            <td>
                                                        ...
                                                        {{ $subscription->ja_name }} {{ $subscription->ja_address_line1 }} {{ $subscription->ja_address_line2 }} {{ $subscription->ja_city }} {{ $subscription->ja_post_code }} {{ $subscription['SubscriptionJaStateAs']['name'] }} {{ $subscription['SubscriptionJaCountryAs']['name'] }}
                                                        @else
                                                            No
                                                        @endif
                                                    </td>
                                        ...
                                        <table class="table table-borderless">
                                    	    <tbody>
                                    	        <tr>
                                    	            ...
                                    	            <td>{{ $subscription->lc_name }}</td>
                                    	            <th width="95px">Email</th>
                                    	            <td>{{ $subscription->lc_email }}</td>
                                    	        </tr>
                                    	        <tr>
                                    	            <th>Mobile No</th>
                                    	            <td>+{{ $subscription->lc_phone_prefix }}{{ $subscription->lc_phone_number }}</td>
                                    	            <th>Facsimile</th>
                                    	            <td>{{ $subscription->lc_facsimile }}</td>
                                    	        </tr>
                                    	    </tbody>
                                    	 </table>
                                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-7 contract-info-invest">
                                    <input type="text" class="form-control" id="investment_name" name="investment_name" placeholder="Ex:JIKISD2012" value="{{$subscription->investment_name}}" required>
                                </div>
...
<div class="modal fade" id="redemptionModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            {!! Form::model($subscription, array('route' => 'flashmsgs.store', 'method'=>'POST', 'files' => true, 'id' => 'formRedemption', 'data-parsley-validate' => 'data-parsley-validate', 'autocomlete'=>"off" )) !!}
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <a href="{{ asset('storage/'.$subscription->redemption_file) }}"  download class="btn btn-base btn-rounded btn-fw mt-1 mr-1">Invester Redemption Form Download </a>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="bank_inan" name="bank_inan" placeholder="Bank IBAN" data-parsley-group="block1" value="{{ $subscription->bank_inan }}" required>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group">
                                <label for="ip">Reference</label>
                                <input type="text" class="form-control" id="reference" name="reference" placeholder="Reference" data-parsley-group="block1" value="{{ $subscription->reference }}" required>
                            </div>
                        </div>
                    </div>
                </div>
