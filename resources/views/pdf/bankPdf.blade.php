...
<body>
	<table width="100%">
        <tr>
            <td rowspan="5" width="20%" align="center"><img src="{{ asset('logo.png') }}" width="140px;" height="95px"></td>
            <td align="center">
	...
	<table  width="100%">
        <tr>
            <td><h4> {{ $subscription->name }}</h4></td>
        </tr>
        <tr>
            <td>{{ $subscription->address_line1 }}</td>
        </tr>
        <tr>
            <td>{{ $subscription->address_line2 }}</td>
        </tr>
        <tr>    
            <td>{{ $subscription->post_code }} {{ $subscription->city }}  {{ $subscription['SubscriptionStateAs']['name'] }} {{ $subscription['SubscriptionCountryAs']['name'] }}.</td>
        </tr>
	    <tr><td>Date: {{ date('d/m/yy') }}</td></tr>
	    <tr><td></td></tr>       
    </table>
	...
	<table width="100%" class="bankdetails" cellspacing="0" cellpadding="0">
		...
		<tr>
            ...
            <td><p> {{ money_format(" %i", $subscription->amount) }}</p></td>
        </tr>
	        <?php
        ...
        <tr>
            ...
            <td><p>{{ money_format(" %i", $percent) }}</p></td>
        </tr>
		<tr>
        ...
        <tr>
            ...
            <td><p><strong>{{ money_format(" %i", $total) }}</strong></p></td> 
        </tr>
		<tr>
			<td><p>Charges:</p></td>
