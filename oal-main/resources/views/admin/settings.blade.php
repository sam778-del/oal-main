				...
				<div class="row">
					<div class="col-lg-12 col-md-12 ">
						...
						<div class="card card-margin">
							...
							<div class="card-body">
							 	{!! Form::model($settings, array('url' => ['master'], 'method'=>'POST', 'files' => true, 'id' => 'user-form', 'data-parsley-validate' => 'data-parsley-validate', "data-parsley-trigger"=>"keyup", 'autocomlete'=>"off" )) !!}
		...
		<div class="modal fade" id="changepasswordDataButton" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					{!! Form::open(['url' => '/changePassword', 'files' => true, 'id' => 'password-form', 'data-parsley-validate' => 'data-parsley-validate', "data-parsley-trigger"=>"keyup", 'autocomlete'=>"off" ]) !!}
                        @csrf
		...
		<div class="modal fade" id="enable2FADataButton" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
			<div class="modal-dialog modal-dialog-centered  modal-lg" role="document">
				<div class="modal-content">
					...
					{!! Form::open(['url' => '/investor/enable2Fa', 'files' => true, 'id' => 'enable2FADataForm', 'data-parsley-validate' => 'data-parsley-validate', "data-parsley-trigger"=>"keyup", 'autocomlete'=>"off" ]) !!}
                        @csrf
						<div class="modal-body">
							<div class="row">
