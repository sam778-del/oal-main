<div class="row mt-4">
	...
	<div class="col-lg-5 col-md-5 col-sm-12">
		<div class="form-group">
			...
			<input type="text" class="form-control" id="lc_phone_number" name="lc_phone_number" placeholder="Phome Number" data-parsley-group="block2" data-parsley-type="digits" value="{{ $subscription->lc_phone_number }}" required>
		</div>
	</div>
