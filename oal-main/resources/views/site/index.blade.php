            ...
            <div class="row align-items-center text-center py-4">
                <div class="col-lg-4 col-md-4 col-sm-4 bottom10">
                    <div class="counters whitecolor top10 bottom10">
                        <span class="count_nums font-light" data-to="{{ $price->latest_price}}" data-speed="2500" data-decimals="2"> </span>
                    </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 bottom10">
                    <div class="counters whitecolor top10 bottom10">
                        <span class="count_nums font-light" data-to="{{ $price->ytd_return}}" data-speed="2500" data-decimals="4"> </span>
                    </div>
...
<section id="steps" class="steps section-bg">
    <div class="container">
        ...
        <div class="row no-gutters">
            ...
            <div class="col-lg-4 col-md-6 content-item wow fadeInUp d-flex align-items-center justify-content-center" data-wow-delay="300ms">
                <div>
                    <a href="https://eservices.mas.gov.sg/cisnetportal/jsp/list.jsp" target="blank"><img alt="" src="{{asset('').'site/assets/img/logo/olympus.webp'}}" width="60px" class="mt-2"></a>
