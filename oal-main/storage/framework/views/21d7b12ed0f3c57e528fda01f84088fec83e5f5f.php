...
<footer class="footer">
    <div class="d-sm-flex justify-content-center justify-content-sm-between">
        ...
        <div class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">
            ...
            <a class="text-primary mr-2" href="#">Privacy Policy</a>
        </div>
    </div>
</footer>
<!-- partial --><?php /**PATH C:\xampp\htdocs\oal-main\oal-main\resources\views/investor/elements/footer.blade.php ENDPATH**/ ?>