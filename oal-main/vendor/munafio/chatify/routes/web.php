...
*/
Route::get('/', 'MessagesController@index')->name(config('chatify.path'))->middleware('admin_check:web');

Route::get('/investor', 'MessagesController@investors')->middleware('subcription_check:web');

//Route::get('/inves', 'MessagesController@investors');
...
Route::get('/investor/{id}', 'MessagesController@investors')->name('user');
