...
<div class="row mt-4">
    ...
    <div class="col-lg-12">
        ...
        <br>
        <a href="<?php echo e(url('/investor/signedPdfDownload')); ?>" target="_blank" download class="btn btn-primary btn-wide btn-sm">Click to review and download your application form</a>
        <br>
    </div>
...
</div><?php /**PATH /var/www/html/olympus-asset.com/public_html/resources/views/investor/elements/editDocument.blade.php ENDPATH**/ ?>