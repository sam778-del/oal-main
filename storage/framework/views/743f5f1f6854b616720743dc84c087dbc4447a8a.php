                ...
                <div class="row register">
                    <div class="col-lg-12 col-md-12 ">
                        <div class="card card-margin">
                            ...
                            <div class="card-body">
                                <?php echo Form::open(['route' => 'register', 'files' => true, 'id' => 'user-form', 'data-parsley-validate' => 'data-parsley-validate', "data-parsley-trigger"=>"keyup", 'autocomlete'=>"off" ]); ?>
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <div class="col-lg-12 col-md-6 col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="address_line1" name="address_line1"  placeholder="Address  Line1" required value="<?php echo e(old('address_line1')); ?>" data-parsley-group="block1">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12 col-md-6 col-sm-12">
                                                        <div class="form-group">
                                                            <label for="time">Address Line 2</label>
                                                            <input type="text" class="form-control" id="address_line2" name="address_line2" placeholder="Address  Line2" value="<?php echo e(old('address_line2')); ?>" data-parsley-group="block1">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <?php echo Form::select('mobile_prefix', $phone_prefix, old('mobile_prefix'), ['class' => 'form-control', 'id'=>'mobile_prefix', "data-parsley-type"=>"digits", 'required' =>'required', 'data-parsley-group'=>"block1",'data-live-search'=>"false"]); ?>
                                                        ...
                                                        <div class="kt-portlet__body">
                                                            <div class="kt-widget kt-widget--general-1">
                                                                <div class="kt-media kt-media--lg">
                                                                    <img src="<?php echo e(asset('/admin/images/sample_image/googleauthenticator.jpg')); ?>" alt="image" style="max-width: 213px; height: 117px;">
                                                                </div>
