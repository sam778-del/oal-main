...
<img src="<?php echo e(config('app.url')); ?>/logo.png" alt="<?php echo e(config('app.name')); ?>" width="120px">
...
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
<?php /**PATH /var/www/html/olympus-asset.com/public_html/resources/views/vendor/mail/html/message.blade.php ENDPATH**/ ?>