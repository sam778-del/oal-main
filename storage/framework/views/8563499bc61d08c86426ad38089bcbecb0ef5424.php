...
<section id="sign-in" class="bglight position-relative padding">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4"> 
                <img src="<?php echo e(asset('').'site/assets/img/integrity.jpg'); ?>" class="parallax img-responsive img-fluid">
            </div>
        </div>
    </div>
</section>
...
</html><?php /**PATH /var/www/html/olympus-asset.com/public_html/resources/views/site/corporateValues.blade.php ENDPATH**/ ?>