<div class="row mt-4">
	...
	<div class="col-lg-2 col-md-2 col-sm-12">
		<div class="form-group">
			...
			<?php echo Form::select('lc_phone_prefix', $phone_prefix, $edit ? $subscription->lc_phone_prefix : old('lc_phone_prefix'), ['class' => 'form-control', 'id'=>'lc_phone_prefix', 'data-parsley-group'=>"block2"]); ?>
	...
	<div class="col-lg-5 col-md-5 col-sm-12">
		<div class="form-group">
			...
			<input type="text" class="form-control" id="lc_phone_number" name="lc_phone_number" placeholder="Phome Number" data-parsley-group="block2" data-parsley-type="digits" value="<?php echo e($edit ? $subscription->lc_phone_number : old('lc_phone_number')); ?>" required>
		</div>
	</div>
...
</div><?php /**PATH /var/www/html/olympus-asset.com/public_html/resources/views/admin/elements/additional.blade.php ENDPATH**/ ?>