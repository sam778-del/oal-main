            ...
            <ul class="nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="ui-contract">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"><a class="nav-link" href="<?php echo e(url('/draft')); ?>">Draft</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo e(url('/pending')); ?>">Pending</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo e(url('/pendingFunding')); ?>">Pending Funding</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo e(url('/active')); ?>">Active</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo e(url('/rejected')); ?>">Rejected</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo e(url('/matured')); ?>">Redemption</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo e(url('/maturedRequest')); ?>">Redemption Req.</a></li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item">
                    ...
                    <div class="collapse" id="cms">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"><a class="nav-link" href="<?php echo e(url('/prices')); ?>">Prices</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo e(url('/newsletters')); ?>">Newsletter</a></li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="investors">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('users.index')); ?>">Investors Active</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo e(url('/deactive-invester')); ?>">Investors in-active</a></li>
                        </ul>
                    </div>
                </li>
