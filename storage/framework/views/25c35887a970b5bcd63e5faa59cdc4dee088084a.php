                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 ">
                                    <div class="card card-margin">
                                        ...
                                        <div class="card-body">
                                             <?php echo Form::open(['url' => '/subscriptionEditSave', 'files' => true, 'id' => 'subscriptionform', 'data-parsley-validate' => 'data-parsley-validate', "data-parsley-trigger"=>"keyup", 'autocomlete'=>"off" ]); ?>

                                                
                                                <?php echo Form::hidden('id', $subscription['id']); ?>
                                                ...
                                                <div>
                                                    ...
                                                    <section>
                                                        ...
                                                        <div class="row">
                                                                <?php echo $__env->make("admin.elements.editSubscription", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                        </div>
                                                    </section>
                                                    ...
                                                    <section>
                                                        ...
                                                        <?php echo $__env->make("admin.elements.editAdditional", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                    </section>

                                                    <h3>DOCUMENTS</h3>
                                                    <section>
                                                        <h4>CHECKLIST FOR SUBSCRIBERS</h4>
                                                        <?php echo $__env->make("admin.elements.editDocument", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                    </section>
