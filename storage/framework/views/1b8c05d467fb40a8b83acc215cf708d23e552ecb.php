	...
	<div class="row sec2-form mt-3">
		...
		<div class="col-lg-12 col-md-6 col-sm-12">
			<div class="form-group">
				...
				<?php echo Form::select('is_joint_account', $jointOption, $subscription->is_joint_account, ['class' => 'form-control', 'id' => 'is_joint_account', 'data-parsley-group'=>"block1", 'required', 'onchange'=>"jointApplicant()", 'data-parsley-group'=>"block1", 'required'=>"required"]); ?>
...
</div><?php /**PATH /var/www/html/olympus-asset.com/public_html/resources/views/admin/elements/editSubscription.blade.php ENDPATH**/ ?>