                                             ...
                                             <?php echo Form::open(['url' => '/subscriptionSave', 'files' => true, 'id' => 'subscriptionform', 'data-parsley-validate' => 'data-parsley-validate', "data-parsley-trigger"=>"keyup", 'autocomlete'=>"off" ]); ?>
                                                ...
                                                <div>
                                                    ...
                                                    <section>
                                                        ...
                                                        <div class="row">
                                                                <?php echo $__env->make("investor.elements.editSubscription", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                        </div>
                                                    </section>
                                                    ...
                                                    <section>
                                                        ...
                                                        <?php echo $__env->make("investor.elements.editAdditional", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                    </section>

                                                    <h3>DOCUMENTS</h3>
                                                    <section>
                                                        <h4>CHECKLIST FOR SUBSCRIBERS</h4>
                                                        <?php echo $__env->make("investor.elements.editDocument", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                    </section>
