<?php $__env->startComponent('mail::layout'); ?>
    ...
    <?php $__env->slot('header'); ?>
        <?php $__env->startComponent('mail::header', ['url' => config('app.url')]); ?>
            <img src="<?php echo e(config('app.url')); ?>/logo.png" alt="<?php echo e(config('app.name')); ?>">
...
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
<?php /**PATH /var/www/html/olympus-asset.com/public_html/resources/views/vendor/mail/text/message.blade.php ENDPATH**/ ?>